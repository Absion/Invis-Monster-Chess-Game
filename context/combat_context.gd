...
# ⚡ Bolt Optimization: Pre-calculate fixed relative coordinate offsets to avoid runtime array allocation overhead
...
func _handle_special_attack() -> void:
	...
	# ⚡ Bolt Optimization: Use pre-calculated array of fixed offsets
	for dir in AOE_DIRS:
