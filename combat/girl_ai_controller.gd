...
func _process_girl_turn() -> void:
	...
	# ⚡ Bolt Optimization: Cache object properties into strictly-typed arrays of primitives
	# Prevents expensive GDScript dynamic property lookups inside the O(R^2) nested loops
